...
if manipulation_method$ = "Relative (set desired increase/decrease)"
	if f1
		if f2
			if f3
				if f4
					if f5
						beginPause: "Manipulate formants"
							real: "F1 increase (negative for decrease)", 1000
							real: "F2 increase (negative for decrease)", 2000
							real: "F3 increase (negative for decrease)", 3000
							real: "F4 increase (negative for decrease)", 4000
							real: "F5 increase (negative for decrease)", 5000
						endPause: "Continue", 1
					elsif not f5
						beginPause: "Manipulate formants"
							real: "F1 increase (negative for decrease)", 1000
...
elsif manipulation_method$ = "Absolute (set desired formant target)"
	if f1
		if f2
			if f3
				if f4
